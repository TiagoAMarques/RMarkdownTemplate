...
Here we explore the results using @Marques2013b.
...
By kniting this template and going back and forth over the .Rmd and comparing it with the output (html, pdf or word) one can see how the different features of RMarkdown are set up, and hence get up to speed with generating dynamic reports without really knowing what you are doing. 
